        ...
        <div class ="container">
            <div class="row">
                ...
                <form class="form-search" action="departmentDesicion" method="post">
                 ...
                 <hr/>
                  <form class="form-horizontal" action="deDeptDesicion" method="post">
                    ...
                    <tbody>
                        <c:forEach var = "deCandidate" items = "${des}"   >
                                <tr>
                                    ...
                                    <td><input type="text"  value ="${deCandidate.dePK .jambNo}" name="jambNo" readonly="readonly"</td>
                                    <td> ${deCandidate.name}</td>

                                <td> <select name="${deCandidate.dePK.jambNo}" value ="" >
                                        <option >${deCandidate.status}</option>
