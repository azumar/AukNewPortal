    ...
    <body>
        <div class ="container">
            <div class="row">
                ...
                <form class="form-search" action="finalApproval" method="post">
                 ...
                 <hr/>
                  <form class="form-horizontal" action="finalApproval" method="post">
                        ...
                        <c:forEach var = "utmeCandidate" items = "${utmeList}"  >
                            <tr>
                                ...
                                <td> <select name="${utmeCandidate.utmePK.jambNo}" value ="" >
                                        <option >${utmeCandidate.admitted}</option>
                                        <option >YES</option>
                                        <option >NO</option>
