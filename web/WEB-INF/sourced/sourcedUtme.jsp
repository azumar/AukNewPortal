...
<html>
    ...
    <body>
        <div class="container"> <!-- start Container -->
            <!-- PAGE CONTENT ${user.name} 
            <div class="row"> --> 
                <h3>WELCOME Your Access Code is Genuine! </h3> 
            </div>
            <section>
                <div class="row c-product-showcase">
                    ...
                    <div class="span6">
                        ...
                        <ul>
                            <li>Make sure you enter correct Jamb No (Not Applicable to Pre-Degree),  before you submit the application.  Note that you will not be allowed to change Jamb No. thereafter.</li>
                        ...
                        <h4><a href="ijmb">For IJMB Application click here  </a></h4>
                        <h4><a href="newSourcedUtme">For UTME Application click here  </a></h4>
                        <h4><a href="deApplication">For DE Application Click here   </a></h4>
                         <h4><a href="predegree">For PRE-DEGREE Application Click here   </a></h4>
                         <h4><a href="pg">For POST-GRADUATE Application Click here   </a></h4>
                    </div>
