 ...
 */
@Embeddable
public class DePK implements Serializable {
    ...
    public DePK(int id, String jambNo) {
        this.id = id;
        this.jambNo = jambNo;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DePK)) {
            return false;
        }
        DePK other = (DePK) object;
        if (this.id != other.id) {
            return false;
        }
    ...
    public String toString() {
        return "entity.DePK[ id=" + id + ", jambNo=" + jambNo + " ]";
    }
