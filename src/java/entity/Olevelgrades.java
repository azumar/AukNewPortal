...
@NamedQueries({
    ...
    @NamedQuery(name = "Olevelgrades.findByGname", query = "SELECT o FROM Olevelgrades o WHERE o.gname = :gname")})
public class Olevelgrades implements Serializable {
    ...
    public Olevelgrades(Integer id) {
        this.id = id;
    }
    ...
    public String toString() {
        return "controller.Olevelgrades[ id=" + id + " ]";
    }
